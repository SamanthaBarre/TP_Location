...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    public function listeVehiculeLoue($dtDebutResa , $dtFinResa):array{
        ...
        $vehiculeReservee =  $this->createQueryBuilder('c')
                    ...
                    ->orWhere('c.dt_heure_depart BETWEEN :dtDebut AND :dtFIN')
                    ->orWhere('c.dt_heure_fin BETWEEN :dtDebut AND :dtFIN')
                    ->orWhere('c.dt_heure_depart <= :dtDebut AND c.dt_heure_fin >= :dtFIN')
                    ->orWhere('c.dt_heure_depart >= :dtDebut AND c.dt_heure_fin <= :dtFIN')
