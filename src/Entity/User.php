...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getStEnregistrement(): ?\DateTimeInterface
    {
        return $this->st_enregistrement;
    }

    public function setStEnregistrement(\DateTimeInterface $st_enregistrement): self
    {
        $this->st_enregistrement = $st_enregistrement;
